...
grep -Fq 'DEPLOY_BUILD_ON_VPS' "$script"
grep -Fq 'git ls-files -z --cached' "$script"
grep -Fq 'npm run check && npm run build' "$script"
grep -Fq 'npm prune --omit=dev' "$script"
grep -Fq '/api/health/live' "$script"
grep -Fq 'internal_live_health_url' "$script"
grep -Fq 'public_live_health_url' "$script"
grep -Fq 'AFS_BASE_URL' "$script"

...
const FAQS = [
  ...
  },
  {
    ...
    a: "ندعم: فودافون كاش (01098553911)، اتصالات كاش (01126665741)، وInstaPay (01285558567). بعد التحويل، ارفع صورة الإيصال في صفحة المدفوعات وسيتم التفعيل خلال ساعات.",
  },
  {
      ...
      <div className="bg-gradient-to-br from-primary/15 via-background to-secondary/10 border-b border-border/40">
        <div className="container px-4 py-16 text-center">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <a
              href="https://wa.me/201098553911?text=مرحباً، أحتاج مساعدة في استخدام منصة سوق للإعلانات"
              target="_blank"

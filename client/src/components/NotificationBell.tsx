  ...
  return (
    <>
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side="right" className="w-80 sm:w-96 p-0 flex flex-col" dir="rtl">
          <SheetHeader className="px-4 py-3 border-b flex-row items-center justify-between space-y-0">
            <div className="flex items-center gap-2">
              <Bell className="w-4 h-4 text-primary" />
              <SheetTitle className="text-sm">الإشعارات</SheetTitle>
              {unread > 0 && (
                ...
                return (
                  <div
                    ...
                    onClick={() => {
                      ...
                      if (n.link && !isVoiceNotif) { setOpen(false); setLocation(n.link); }
                    }}
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {!isVoiceNotif && n.link && (
                        <button
                          onClick={e => { e.stopPropagation(); markReadMutation.mutate(n.id); setOpen(false); setLocation(n.link); }}
